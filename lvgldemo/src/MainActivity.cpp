...
void MainActivity::onCreate() {
    ...
    mBtns.push_back(lvUtils::createLabelButton(&root, "open music", {LV_ALIGN_CENTER, -100, 0},
                                               [this](lv_event_t *) {
    ...
    mBtns.push_back(lvUtils::createLabelButton(&root, "open widgets", {LV_ALIGN_CENTER, 100, 0},
                                               [this](lv_event_t *) {
                                                   Intent intent(getPackageName() +
                                                                 "/WidgetsActivity");
                                                   startActivity(intent);
